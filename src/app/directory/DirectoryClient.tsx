...
export const providers: Provider[] = [
  ...
  // Government contacts
  {
    ...
    description: "Handles civil documentation, immigration permits, and residency matters relevant to businesses employing foreign nationals in Seychelles.",
  ...
  },
  {
    ...
    description: "The primary government body for employment law, labour regulations, work permits, and workforce development in Seychelles.",
    website: "www.employment.gov.sc",
    websiteHref: "https://www.employment.gov.sc",
    email: "employment@gov.sc",
    phone: null,
  },
  {
    id: "3",
