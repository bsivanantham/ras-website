...
export const providers: Provider[] = [
  ...
  {
    id: "ras-compliance",
    name: "RAS Compliance Hub",
    category: "Health & Safety",
    description: "Compliance checklists and guides for Seychelles retailers — health & safety, food handling, expiry date monitoring, damaged goods procedures, and FTC price control rules. Members only.",
    website: "ras.sc/compliance",
    websiteHref: "https://ras.sc/compliance",
    email: null,
    phone: null,
  },
  {
