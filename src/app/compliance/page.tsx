...
const govLinks = [
  {
    ...
    description: "Responsible for food safety inspections, health certificates, and enforcement.",
    url: "#",
  },
  {
    name: "Seychelles Bureau of Standards",
    description: "Sets and enforces product standards, labelling requirements, and certifications.",
    url: "#",
  },
  {
    name: "Environmental Protection Agency",
    description: "Oversees environmental compliance, waste disposal, and chemical handling.",
    url: "#",
  },
  {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-white/80 text-lg leading-relaxed">
              ...
              covers the four pillars of retail compliance — with practical checklists you can
              action today.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-gray-700 leading-relaxed">
              The Retailers Association of Seychelles works closely with the Public Health
              Authority, Seychelles Bureau of Standards, and other regulatory bodies to ensure our
              members always have the most current compliance guidance. Use the checklists below
              to conduct regular self-audits and identify any gaps before an official inspection.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#EFF4FF]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
          {pillars.map((pillar) => (
            <Card
              key={pillar.title}
              className="bg-white border border-[#0D3572]/10 shadow-sm overflow-hidden"
            >
              <CardHeader className="border-b border-gray-100 bg-[#0D3572]/5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-gray-600 text-sm mt-1 leading-relaxed">
                      {pillar.description}
                    </CardDescription>
                  </div>
                </div>
              ...
              <CardContent className="pt-6">
                <h4 className="text-sm font-semibold text-[#0D3572] mb-4 uppercase tracking-wide">
      ...
      <section className="py-10 bg-[#C9A227]/15 border-y border-[#C9A227]/30">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-xl font-bold text-[#0D3572] mb-1">
                Need help with compliance? Contact RAS.
              </h3>
              <p className="text-gray-700 text-sm leading-relaxed max-w-xl">
                Our team can assist with compliance queries, connect you with the right government
                department, or arrange a compliance review for your store.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              ...
              <a href="mailto:info@retailers.sc">
                <Button
                  variant="outline"
                  className="border-[#0D3572] text-[#0D3572] hover:bg-[#0D3572] hover:text-white gap-2 w-full sm:w-auto"
                >
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-[#0D3572] mb-2">
              Useful Government Links
            </h2>
            <p className="text-gray-600 text-sm">
              Direct access to the regulatory bodies that Seychelles retailers interact with most.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {govLinks.map((link) => (
              <a
                key={link.name}
                href={link.url}
                className="flex items-start gap-4 p-5 rounded-xl border border-[#0D3572]/10 bg-[#EFF4FF] hover:bg-[#e3ecff] hover:border-[#0D3572]/30 transition-colors group"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#0D3572] shrink-0">
                  <ExternalLink className="h-5 w-5 text-white" />
                </div>
                <div className="flex-1">
                  <p className="font-semibold text-[#0D3572] text-sm group-hover:text-[#C9A227] transition-colors">
                    {link.name}
                  </p>
      ...
      <section className="bg-[#0D3572] py-10 text-center text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h3 className="text-xl font-bold mb-3">Download Our Compliance Checklists</h3>
          <p className="text-white/70 text-sm mb-5">
            Members can download print-ready versions of all checklists from the Resources library.
          </p>
          <Link href="/resources">
